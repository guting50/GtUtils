...
public final class SpanUtil {
    ...
    public static class SpanBuilder {
         ...
         * @return
         */
        public SpanBuilder setClickableSpan(String section, ClickableSpan clickableSpan) {
            return setClickableSpan(section, clickableSpan, Which.LAST);
        }
         ...
         * @return
         */
        public SpanBuilder setClickableSpan(String section, final ClickableSpan clickableSpan, @NonNull Which which) {
            return onDecor(section, false, which, new DecorCallback() {
                @Override
                public void decor(int start, int end) {
                    setClickableSpan(clickableSpan, start, end);
                }
            });
        }
         ...
         * @return
         */
        public SpanBuilder setClickableSpan(final ClickableSpan clickableSpan, int start, int end) {
            spanStrBuilder.setSpan(new ClickableSpan() {
                @Override
