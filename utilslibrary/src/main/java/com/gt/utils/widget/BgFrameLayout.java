 ...
 * <attr name="stroke_dashGap" format="dimension" /><!--间隔-->
 * <attr name="stroke_dashWidth" format="dimension" /><!--点的大小-->
...
public class BgFrameLayout extends FrameLayout {
    ...
    public BgFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        stroke_width = typedArray.getDimension(R.styleable.BgFrameLayout_stroke_width, 0);
        stroke_dashGap = typedArray.getDimension(R.styleable.BgFrameLayout_stroke_dash_gap, 0);
        stroke_dashWidth = typedArray.getDimension(R.styleable.BgFrameLayout_stroke_dash_width, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (stroke_width != 0) {
            ...
            paint.setPathEffect(new DashPathEffect(new float[]{stroke_dashWidth, stroke_dashGap}, 0));
        ...
        //该方法5.0以上才支持
//        path.addRoundRect(stroke_width * 2, stroke_width * 2, this.getWidth() - stroke_width * 2, this.getHeight() - stroke_width * 2,
//                corners_radius, corners_radius, Path.Direction.CW);
    ...
    public void setStrokeDashGap(float stroke_dashGap) {
        this.stroke_dashGap = stroke_dashGap;
        invalidate();
    }

    public void setStrokeDashWidth(float stroke_dashWidth) {
        this.stroke_dashWidth = stroke_dashWidth;
        invalidate();
    }
